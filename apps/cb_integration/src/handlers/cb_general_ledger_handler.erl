%% @doc General Ledger HTTP Handler
%%
%% Endpoint:
%%   GET /api/v1/ledger/general-ledger
%%
%% Returns a paginated view of all ledger entries, optionally filtered
%% by account, entry type, currency, and date range. This is the primary
%% endpoint for general ledger reporting and audit.
%%
...
%%
%% Response:
%%   { items: [LedgerEntry], total, page, page_size }
%%
-module(cb_general_ledger_handler).
